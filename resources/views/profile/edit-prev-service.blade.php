    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="" id="edit-ps-form">
                ...
                <input type="hidden" name="user_id" value="{{$user->id}}" id="ps-edit-user_id">
                ...
                <div class="modal-body">
                    ...
                    <div class="internal-company">
                        <div class="internal-company">
                            ...
                            <div class="form-group">
                                <select class="ps-edit-department_id" name="department_id" form="edit-ps-form" id="ps-edit-department_id">
                                </select>
                            </div>
                        </div>
