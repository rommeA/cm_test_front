...
@section('title')
    Candidates — Crew Master
@endsection
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __("Home") }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ trans_choice("Candidates", 2) }}</li>
        </ol>
    </nav>
@endsection
        ...
        <div class="btn-group">
            <div class="dropdown">
                <h4 type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true">
                    {{ trans_choice('Candidates', 2) }} <i class="fa-solid fa-angle-down"></i>
                </h4>
...
@section('forms')
    @can('update', App\Models\User::class)
        @include('employees.candidates.edit')
    @endcan
            ...
            table = $('#usersTable').DataTable( {
                ...
                "columns": [
                    ...
                    { data: 'documentStatus', orderable: false, class: 'company-row'},
                    {
                        ...
                        orderable: false,
                        data: 'id'
                        // defaultContent: '<a href="#" id="edit-item" data-user-id="'+''+'" class="btn edit-user" data-bs-toggle="modal" data-bs-target="#editUserModal"><i class="fa-solid fa-pen-to-square"></i></a>',
                    },
                    {
